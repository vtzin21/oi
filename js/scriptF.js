...
document.addEventListener("DOMContentLoaded", function() {
    loadAthletesF('feminino');

});

function loadAthletesF(endpoint) {
...
function renderAthletes(athletesData) {
    const athletesContainer = document.getElementById('athletes-containerF');
...
function renderAthleteDetails(detailsData) {
    const detailsContainer = document.getElementById('athletes-containerF');
